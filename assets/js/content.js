  ...
  en: {
    ...
    highlights: {
      ...
      items: [
        ...
        { year: "", title: "90 Events for 30,000 Students", detail: "Designed and managed approximately 90 national and international events, engaging over 30,000 students." },
      ...
      items: [
        {
          ...
          bullets: [
            ...
            "Oversaw periodic performance reviews, evaluated outcomes and KPIs, and developed comprehensive annual reports to inform management and strategic decision-making.",
          ],
        },
        {
  ...
  ar: {
    ...
    highlights: {
      ...
      items: [
        ...
        { year: "", title: "90 فعالية لـ 30,000 طالب", detail: "صمّمت وأدرت نحو 90 فعالية وطنية ودولية شارك فيها أكثر من 30,000 طالب." },
      ...
      items: [
        {
          ...
          bullets: [
            ...
            "الإشراف على مراجعات الأداء الدورية وتقييم النتائج ومؤشرات الأداء الرئيسية وإعداد تقارير سنوية شاملة لدعم اتخاذ القرار الاستراتيجي.",
          ],
        },
        {
